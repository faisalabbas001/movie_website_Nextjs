                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        <div className={footerStyles['logo-details']}>
                            ...
                            <span className={footerStyles.logo_name}>Faisal_CodeMaster</span>
                        </div>
                    ...
                    <div className={footerStyles['link-boxes']}>
                        ...
                        <ul className={footerStyles.box}>
                            <li className={footerStyles.link_name}>Hit Movies</li>
                            <li><a href="#">Black Panther</a></li>
                            <li><a href="#">Fast and Fuirous</a></li>
                            <li><a href="#">Peakey Blider</a></li>
                            <li><a href="#">Not noise</a></li>
                        </ul>
                        <ul className={`${footerStyles.box} ${footerStyles['input-box']}`}>
                            <li className={footerStyles.link_name}>Follow Plz</li>
                            <li><input type="text" placeholder="Enter your email" /></li>
                            <li><input type="button" value="Fallow" /></li>
                        </ul>
                    </div>
                </div>
                <div className={footerStyles['bottom-details']}>
                    <div className={footerStyles.bottom_text}>
                        <span className={footerStyles.copyright_text}> Copyright © 2023
                            <Link href="/>"> Faisal_CodeMaster </Link> All rights reserved </span>
